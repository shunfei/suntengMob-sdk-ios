...
#import "SMADemoInterstitialAdViewController.h"
#import "SuntengMobileAds.h"

@interface SMADemoInterstitialAdViewController () <SMAInterstitialAdControllerDelegate>

@property (nonatomic, weak) IBOutlet UITextView *logView;
@property (nonatomic, weak) SMAInterstitialAdController *interstitialAdController;
@property (nonatomic, assign) BOOL isLoading;

@end

@implementation SMADemoInterstitialAdViewController
...
#pragma mark - SMAInterstitialAdControllerDelegate
