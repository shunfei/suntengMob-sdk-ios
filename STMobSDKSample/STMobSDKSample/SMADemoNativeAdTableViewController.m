//
//  SMADemoNativeAdTableViewController.m
//  STMobSDKSample
//
...
#import "SMADemoNativeAdTableViewController.h"
#import "SMANativeAd.h"
#import "CustomNativeAdCell.h"

@interface SMADemoNativeAdTableViewController () <SMANativeAdDelegate>
@property (nonatomic, strong) NSMutableArray *tableViewContentArray;
@property (nonatomic, strong) SMANativeAd *topPlaceNativeAd;

@end

@implementation SMADemoNativeAdTableViewController
...
- (IBAction)fetchAd:(id)sender {
    self.topPlaceNativeAd = [[SMANativeAd alloc] initWithAdUnitID:@"2-36-53"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([data isKindOfClass:[NSString class]]) {
        ...
        // 获取nativeAd
        SMANativeAd *nativeAd = self.tableViewContentArray[indexPath.row][@"ad"];
